...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("doc_fix_wayland", "https://Netdesk.com/docs/en/manual/linux/#x11-required"),
        ...
        ("confirm_idd_driver_tip", "The option to install the virtual display driver is checked. Note that a test certificate will be installed to trust the virtual display driver. This test certificate will only be used to trust Netdesk drivers."),
