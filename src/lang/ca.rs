...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connexió a la xarxa Netdesk en progrés..."),
        ...
        ("android_input_permission_tip1", "Per a que un dispositiu remot controli el seu dispositiu Android amb el ratolí o tocs, cal permetre que Netdesk utilitzi el servei d' \"Accesibilitat\"."),
        ("android_input_permission_tip2", "Vagi a la pàgina de [Serveis instal·lats], activi el servici [Netdesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep Netdesk background service", "Mantenir Netdesk com a servei en segon pla"),
